...
export default function () {
  ...
  Accounts.onCreateUser((options, user) => {
    ...
    const defaultVisitorRole =  ["anonymous", "guest", "product", "tag", "index", "cart/checkout", "cart/completed", "FAQs"];
    const defaultRoles =  ["guest", "account/profile", "product", "tag", "index", "cart/checkout", "cart/completed", "FAQs"];
    const roles = {};
    const additionals = {
