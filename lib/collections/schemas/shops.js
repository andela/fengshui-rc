...
export const Shop = new SimpleSchema({
  ...
  "defaultVisitorRole": {
    type: [String],
    defaultValue: ["anonymous", "guest", "product", "tag", "index", "cart/checkout", "cart/completed", "FAQs"]
  },
  "defaultRoles": {
    type: [String],
    defaultValue: ["guest", "account/profile", "product", "tag", "index", "cart/checkout", "cart/completed", "FAQs"]
  },
  "layout": {
    type: [Layout],
    optional: true
