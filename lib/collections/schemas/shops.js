...
export const Shop = new SimpleSchema({
  ...
  "defaultVisitorRole": {
    type: [String],
    defaultValue: ["anonymous", "guest", "product", "tag", "index", "cart/checkout", "cart/completed", "help"]
  },
  "defaultRoles": {
    type: [String],
    defaultValue: ["guest", "account/profile", "product", "tag", "index", "cart/checkout", "cart/completed", "help"]
  },
  "layout": {
    type: [Layout],
    optional: true
